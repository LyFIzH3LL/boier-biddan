    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-green-100 text-gray-800">
            <div className="bg-white shadow-lg rounded-2xl p-6 md:p-8 text-center">
                <h2 className="text-3xl font-bold text-green-600 font-noto-sans-serif">আপনার অনুদানের জন্য আপনাকে অসংখ্য ধন্যবাদ 🎉</h2>
                <p className="text-lg mt-4 font-noto-sans-serif text-primary">"বইয়ের বিদ্যান" টিমের পক্ষ থেকে আপনাদের জন্য রইলো অনেক দোয়া, প্রার্থনা এবং শুভকামনা।</p>
